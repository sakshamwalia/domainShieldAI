...
class dbOperations:
    ...
    def dataBaseConnection(self):
        ...
        try:
            cloud_config = {
                "secure_connect_bundle": "secure-connect-domainsheildai.zip"
            }
            
            auth_provider = PlainTextAuthProvider("HBmvNeqKgZhQIYPAhUUDpjOG", "fdcHdUyeNkzCfDGQUcvm0rWM7SNuZY-SeDAh2Ts9RmA9AUl-+2FZZLAqrZ57QZAWj+WedbcjnireHB4WR46TXbHl_B5Y75Qu-QiimI2Z8i9l8O1RbMCcH0,no7Ig01IT")
