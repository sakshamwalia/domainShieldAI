...
from src.utils import read_params, save_model, find_best_model
import pandas as pd
...
def model_selection_and_tuning(config_path):
    """
                    ...
                    Description: Selects a best model from all classification model having best accuracy and auc_roc_score and does hyperparameter tuning
    ...
    try:
        ...
        logger.log(file, 'Hyperparameter tuning is completed and after comparing auc_roc_score and accuracy score of models, we are going to select model having hyperparameters: ' + str(param))
