...
import argparse
from src.utils import read_params, correlation, clean_prev_dirs_if_exists, create_dir
import pandas as pd
...
def data_preprocessing(config_path):
    """
                        ...
                        Description : This method performs data preprocessing by reading parameters from param.yaml and then performing feature engineering and feature selection based on EDA given in Jupyter notebooks/EDA and preprocessing.
    ...
    try:
        ...
        # Finding features having 0 variance in training data
