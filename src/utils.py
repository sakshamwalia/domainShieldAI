...
def create_dir(dirs : list):
    """
                        ...
                        Description: This method performs creation of directory to help stage_01_data_preprocessing to store preprocessed data into it
...
def correlation(dataset, threshold):
    """
                        ...
                        Description: This method performs finding correlation among all features of input data and then depending upon the threhold return list of features.
...
def objective(trial, X_train, y_train):
    ...
    try:
        classifier_name = trial.suggest_categorical("classifier", ["LogReg", "RandomForest", "SVC", "NaiveBayes", "decision-tree", "xgb"])
